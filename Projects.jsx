              ...
              <div className="relative z-20 p-6 flex flex-col">
                ...
                <div className="flex gap-2 mt-auto w-full">
                  <a
                    ...
                    className="flex-1 text-center py-3 rounded-full font-semibold transition border bg-gradient-to-r from-purple-600/20 to-purple-600/20 hover:from-purple-600 hover:to-purple-500 border-purple-500/30 hover:border-purple-400 hover:scale-105"
                  >
                    GitHub
                  </a>
                </div>
