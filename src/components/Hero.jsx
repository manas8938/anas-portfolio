        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <p className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-2xl mx-auto md:mx-0">
              ...
              <span className="text-pink-400 font-semibold">Database</span>,{' '}<span className="text-blue-400 font-semibold">Cloud</span>, and Modern UI/UX principles.
            </p>

            <div className="flex flex-wrap gap-6 py-4 border-y border-white/10 my-2">
              {[
                { number: "100+", label: "APIs Built" },
                { number: "p95 < 266ms", label: "API Latency" },
                { number: "200+", label: "Tests Written" },
                { number: "🇸🇦 Live", label: "Production KSA" },
              ].map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  <span className="text-lg font-bold text-cyan-400">{stat.number}</span>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative group">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-pink-500 to-cyan-600 rounded-full blur opacity-60 group-hover:opacity-90 transition-opacity duration-500"></div>
